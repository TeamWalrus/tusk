...
export default function NavBar() {
  ...
  useEffect(() => {
    const userSetPreference = getThemePref();
  ...
  return (
    <nav>
      <div className="navbar bg-base-100 pb-4 pt-4">
        <div className="navbar-start">
          <div className="dropdown ">
            ...
            <ul
              tabIndex={0}
              className="menu-compact dropdown-content menu rounded-box relative z-10 mt-3 w-52 bg-base-100 p-2 shadow"
            >
              <li>
                <a href="/">Home</a>
              </li>
